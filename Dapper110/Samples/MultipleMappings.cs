...
{
    public static async Task RunSampleAsync(string connectionString) => await SimpleMappingAsync(connectionString);//await ListMappingAsync(connectionString);//await AliasMappingAsync(connectionString);
